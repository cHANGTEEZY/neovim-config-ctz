...
![Neovim, Lua, TypeScript, JavaScript, React, Node.js, Go, HTML, CSS, Git, macOS, Linux, Bash, VS Code](https://skillicons.dev/icons?i=neovim,lua,ts,js,react,nodejs,go,html,css,git,apple,linux,bash,vscode)
...
| **Go** | `gopls` + golangci-lint, goimports/gofumpt on save, test/run from the buffer |
...
Language servers and formatters land through [Mason](https://github.com/mason-org/mason.nvim): TypeScript, ESLint, Go (`gopls`, goimports, gofumpt, golangci-lint), JSON, HTML, CSS, Lua, Prettier.
...
1. Installs Neovim **0.12+** and tools (`git`, `ripgrep`, `fd`, `node`, `go`)
